...
/// Paints a [SkipDashedLineConnector].
class SkipDashedLinePainter extends CustomPainter {
  /// Creates a dashed line painter.
  const SkipDashedLinePainter({
  ...
  @override
  bool shouldRepaint(SkipDashedLinePainter oldDelegate) {
